package fr.unice.polytech.soa1.creditgeneral.rpc;
...
import fr.unice.polytech.soa1.creditgeneral.business.Status;
...
@WebService(targetNamespace = "http://informatique.polytech.unice.fr/soa1/payment/rpc/public",
		...
		endpointInterface = "fr.unice.polytech.soa1.creditgeneral.rpc.RetailerRPC")
